**NPM:** [npmjs.com/package/listing-discordtownshop-com](https://www.npmjs.com/package/listing-discordtownshop-com/)<br>



<a href="https://nodei.co/npm/listing-discordtownshop-com"><img src="https://nodei.co/npm/listing-dtl-api.png?downloads=true&stars=true" alt="npm installnfo" /></a>
...
#### 5. How can I get my bot's server count?
  `Ans: JavaScript:`
```js
const listing = require("listing-discordtownshop-com");
...
#### 7. Full Example?
  `Ans:`
```js
const listing = require("list-discordtownshop-com");
const dbl = new listing("TOKEN-HERE", client);
